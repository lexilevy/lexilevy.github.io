 ...
 * @polymer
 */
class LexisiteCarousel extends PolymerElement {
  static get template() {
    return html`
      <style>
        :host{
  ...
  ready(){
    ...
    this._startSpinner();
    this._resizeWindowFunction()
    window.resize = function() {this._resizeWindowFunction()};
  }
  ...
  _rotate(){
    var carousel = this.$.carouselid;
    var newdegree = this.currdeg;
    newdegree = newdegree - 45;
    
    // var update_style = {
    //   "-webkit-transform": "rotateY("+newdegree+"deg)",
    //   "-moz-transform": "rotateY("+newdegree+"deg)",
    //   "-o-transform": "rotateY("+newdegree+"deg)",
    //   "transform": "rotateY("+newdegree+"deg)"
    // };
    carousel.style.webkitTransform = "rotateY("+newdegree+"deg)";
    carousel.style.transform = "rotateY("+newdegree+"deg)";
    this.set("currdeg",newdegree);
  }
...
window.customElements.define('lexisite-carousel', LexisiteCarousel);
