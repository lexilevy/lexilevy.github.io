define(["../../node_modules/@polymer/polymer/polymer-element.js","../../node_modules/@polymer/app-layout/app-layout.js","../../node_modules/@polymer/app-layout/app-scroll-effects/app-scroll-effects.js","../../node_modules/@polymer/app-layout/app-header/app-header.js","../../node_modules/@polymer/app-layout/app-toolbar/app-toolbar.js","../../node_modules/@polymer/paper-icon-button/paper-icon-button.js","../../node_modules/@polymer/iron-icons/iron-icons.js","../../node_modules/@polymer/paper-button/paper-button.js","../../node_modules/@polymer/iron-dropdown/iron-dropdown.js","../../node_modules/@polymer/iron-collapse/iron-collapse.js"],function(_polymerElement,_appLayout,_appScrollEffects,_appHeader,_appToolbar,_paperIconButton,_ironIcons,_paperButton,_ironDropdown,_ironCollapse){"use strict";class LexisiteServices extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
    ...
    `}static get properties(){return{}}ready(){super.ready();var self=this,w=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;w=760>w?!0:!1;this.set("mobile",w);$.subscribe("_goto",function(event,data){if("services"==data){window.scroll(0,self._findPos(self.$.content))}})}_findPos(obj){var curtop=0;if(obj.offsetParent){do{curtop+=obj.offsetTop}while(obj=obj.offsetParent);if(this.mobile){curtop-=100}return[curtop]}}_openDropdown(e){var self=this,value=e.target.getAttribute("value");if("one"==value){this.set("dropdownselected","one");self.$.one.toggle();self.$.two.hide();self.$.three.hide();self.$.four.hide()}if("two"==value){this.set("dropdownselected","two");self.$.one.hide();self.$.two.toggle();self.$.three.hide();self.$.four.hide()}if("three"==value){this.set("dropdownselected","three");self.$.one.hide();self.$.two.hide();self.$.three.toggle();self.$.four.hide()}if("four"==value){this.set("dropdownselected","four");self.$.one.hide();self.$.two.hide();self.$.three.hide();self.$.four.toggle()}}}window.customElements.define("lexisite-services",LexisiteServices)});